...
namespace cheetah_inekf_lcm
{
    lcm_handler::lcm_handler(lcm::LCM* lcm, cheetah_lcm_data_t* cheetah_buffer, boost::mutex* cdata_mtx, bool* reinit_cmd) : 
        ...
        // data dimensions:
        q_dim = config_setting["settings"]["leg_q_dimension"] ? config_setting["settings"]["leg_q_dimension"].as<int>() : 12;
        qd_dim = config_setting["settings"]["leg_qd_dimension"] ? config_setting["settings"]["leg_qd_dimension"].as<int>() : 12;
        tau_est_dim = config_setting["settings"]["leg_tau_dimension"] ? config_setting["settings"]["leg_tau_dimension"].as<int>() : 12;
        acc_dim = config_setting["settings"]["imu_acc_dimension"] ? config_setting["settings"]["imu_acc_dimension"].as<int>() : 3;
        omega_dim = config_setting["settings"]["imu_omega_dimension"] ? config_setting["settings"]["imu_omega_dimension"].as<int>() : 3;
        rpy_dim = config_setting["settings"]["imu_rpy_dimension"] ? config_setting["settings"]["imu_rpy_dimension"].as<int>() : 3;
        quat_dim = config_setting["settings"]["imu_quat_dimension"] ? config_setting["settings"]["imu_quat_dimension"].as<int>() : 4;
