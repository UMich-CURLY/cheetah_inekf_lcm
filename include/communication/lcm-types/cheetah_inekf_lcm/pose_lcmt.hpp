...
#ifndef __pose_lcmt_hpp__
#define __pose_lcmt_hpp__
...
int pose_lcmt::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int pose_lcmt::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int pose_lcmt::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t pose_lcmt::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* pose_lcmt::getTypeName()
{
    return "pose_lcmt";
}

int pose_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int pose_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int pose_lcmt::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t pose_lcmt::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x32007f9dd3836576LL;
